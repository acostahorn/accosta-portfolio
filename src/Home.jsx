...
export default function Home() {
    return (
        <>
            ...
            <p className="description">Computing professional recently awarded with distinction with an HNC from New College Lanarkshire, with a 20-year background in senior healthcare management.</p>
            <p className="description">I offer a proven track record of leading large teams (up to 50 staff), managing complex operational workflows, and ensuring regulatory compliance in high-stakes, regulated environments.
